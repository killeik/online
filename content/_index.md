...
Mixed Markdown and [semantic HTML](https://www.w3.org/WAI/WCAG21/Techniques/html/H101), basic CSS, and no JS.

-  Editing in [helix](https://helix-editor.com)
-  Code repository on [GitHub](https://github.com/killeik/online)
-  Rendering from templates/markdown with [Hugo](https://gohugo.io/)
